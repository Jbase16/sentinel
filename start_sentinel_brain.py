...
# 🧠 CONFIGURATION
# Model paths - use external drive for now, can be changed to local symlinks
MODEL_PATH = "/Volumes/ByteMe/SentinelForge/models/gemma-2-9b-it-sft-fused-4bit"
ADAPTER_PATH = "/Volumes/ByteMe/SentinelForge/models/surgical_adapter"
PORT = 8009
